...
(setf *maintain* (format nil "CL-REPL (C) 2017-2018 TANI Kojiro~%  (Maintained by https://github.com/lisp-maintainers/cl-repl)~%Credits to respective library developers that are part of CIEL (https://ciel-lang.org)"))
